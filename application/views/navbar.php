        ...
        <ul class="nav nav-tabs">	
            ...
            <li class="dropdown" >
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?=base_url();?>materiales/ubicarOrden?tipoProducto=acabado"><span class="glyphicon glyphicon-log-out"></span> Salida de Almacén para Producto Acabado</a></li>
					<li><a href="<?=base_url();?>materiales/ubicarOrden?tipoProducto=blanco"><span class="glyphicon glyphicon-log-out"></span> Salida de Almacén para Producto Blanco</a></li>
					 <li class="divider"></li>
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-pencil"></span> Pedidos</a>
						<ul class="dropdown-menu">
							...
							<li><a href="<?=base_url();?>tienda/realizarPedidoM?local=T"><span class="glyphicon glyphicon-pencil"></span> Hacer Pedido para Muestrario</a></li>
					...
					<li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-pencil"></span> Pedidos Zúñiga</a>
						<ul class="dropdown-menu">
							...
							<li><a href="<?=base_url();?>tienda/ubicarPedido?local=Z"><span class="glyphicon glyphicon-pencil"></span> Modificar Pedido Zúñiga</a></li>
            ...
            <li class="dropdown" >
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?=base_url();?>contabilidad/autorizarInicioPeriodoGestion"><span class="glyphicon glyphicon-calendar"></span> Iniciar Per&iacute;odo de  Gesti&oacute;n</a></li>
                </ul>
            </li>
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-list-alt"></span> Inventarios</a>
                    	<ul class="dropdown-menu">
                    		...
                    		<li><a href="<?=base_url();?>materiales/crudMaterialPorCodigo"><span class="glyphicon glyphicon-search"></span> Buscar Material por C&oacute;digo</a></li>
							...
							<li><a href="<?=base_url();?>materiales/buscarIngreso?nombreDeposito=bodega"><span class="glyphicon glyphicon-pencil"></span> Modificar Ingreso de Bodega</a></li>
					...
					<li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-tags"></span> Productos</a>
                    	<ul class="dropdown-menu">
							...
							<li><a href="<?=base_url();?>tienda/crudProductoPorCodigo"><span class="glyphicon glyphicon-search"></span> Buscar Productos F&aacute;brica por C&oacute;digo</a></li>
