...
<style type="text/css" >
	...
	#cuerpo{margin:0 auto; padding:0; width:550px; height:100px;}
...
<div class="jumbotron" id="cuerpo" >	
	...
	<div class="cuerpoCabeceraReporteSalida">
	    <form class='form-horizontal' method='post' action='<?=base_url()?>materiales/generarReporteNumeroOrden' id='form_' name='form_' >
			...
			<p align="center" class="tituloReporte" ><span class="label label-success"> Reporte de Materiales por N&uacute;mero de Orden de Trabajo </span></p>
