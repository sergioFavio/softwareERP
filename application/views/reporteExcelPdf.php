    ...
    <table width="99%" class="table-condensed">   		
		<thead>
    		<tr>
				...
				<p align="center"><span class="label label-success">Reporte <?= $titulo ?> </span> &nbsp;   <button type="button" id="btnExcel" class="btn btn-primary btn-sm" style="font-family:Arial;font-weight:bold;font-size:12px;text-align:center;" onClick="window.location.href='<?=base_url();?>materiales/archivoExcel'"> Excel </button>    </p>				
				</td>
				<td class="letraFecha">
					Hasta: <?= $fechaFinal ?>
				</td>
