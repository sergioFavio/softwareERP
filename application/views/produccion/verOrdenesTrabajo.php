...
<style type="text/css" >
	...
	#cuerpoCabecera{margin:0 auto; padding:0; width:1010px; height:105px;} 					
	#cuerpoDetalle{margin:0 auto; padding:0; width:1010px; height:410px; }					
	#cuerpoPaginacion{margin:0 auto;padding:0;  width:1010px; height:60px;}					
...
<div class="jumbotron" id="cuerpoCabecera" >	<!--cuerpoCrudMaterial-->
	    ...
	    <form class="form-horizontal" method="post" action="<?=base_url()?>produccion/buscarOrdenTrabajo" id="formBuscarRegistro_" name="formBuscarRegistro_" >
			...
			<p align="center" class="tituloReporte" ><span class="label label-default"> Ver Órdenes de Trabajo</span></p>
		   ...
		   <div class="row">
				...
				<div class="col-lg-6">    
			    	<div class="input-group input-group-sm">
			    		<input type="text" class="form-control input-sm" id="inputBuscarPatron" name="inputBuscarPatron" value='<?= $consultaOrdenTrabajo ?>' placeholder="buscar ...">
	...
	<table width="99%" class="table table-striped table-bordered table-condensed" id="tabla1">   		
		<thead>
    		<tr style="background-color: #b9e9ec;" class='letraDetalle'>
				...
				<th style="width: 308px;">Producto</th>
				...
				<th style="width: 70px;">Fecha Acabado</th>
 		...
 		<tbody>	
			<?php  $posicionFila=-1; ?>			
	        <?php foreach($listaOrdenTrabajo as $ordenTrabajo):?>
				<tr class='letraDetalle'>
				
					<?php  $posicionFila=$posicionFila+1;  //...posicionFila
		
					$numeOrdenTrabajo = $ordenTrabajo->numeroPedido.$ordenTrabajo->secuencia;	
							
					 echo"<td style='width:65px;' ><input type='text' id='idOrdenT_".$posicionFila."' name='idOrdenT_".$posicionFila."' value='".$ordenTrabajo->numeroPedido."-".$ordenTrabajo->secuencia."' readonly='readonly' style='border:none; width:65px;text-align:center;' data-toggle='tooltip' title='$ordenTrabajo->cliente'  /></td>";
						
					 echo"<td style='width: 45px;'  ><input type='text' id='codTrab_".$posicionFila."' name='codTrab_".$posicionFila."' value='".$ordenTrabajo->codTrabajador."' readonly='readonly' style='border:none; width:45px;'  data-toggle='tooltip' title='$ordenTrabajo->trabajador'  /></td>";
							 
					 echo"<td style='width: 300px;'><input type='text' id='producto_".$posicionFila."' name='producto_".$posicionFila."' value='".$ordenTrabajo->descripcion."' readonly='readonly' style='border:none; width:300px;' data-toggle='tooltip' title='$ordenTrabajo->color'  /></td>";
						
					 echo"<td style='width: 25px;'><input type='text' id='cant_".$posicionFila."' name='cant_".$posicionFila."' value='".$ordenTrabajo->cantidad."' readonly='readonly' style='border:none; width:25px;text-align:right;' /></td>";
					
					 echo"<td style='width: 40px;'><input type='text' id='estado_".$posicionFila."' name='estado_".$posicionFila."' value='".$ordenTrabajo->unidad."' readonly='readonly' style='border:none; width:40px;' /></td>";
					
					 echo"<td style='width: 60px;'><input type='text' id='fechaInicial_".$posicionFila."' name='fechaInicial_".$posicionFila."' value='".$ordenTrabajo->fechaInicial."' readonly='readonly' style='border:none; width:60px;' /></td>";
					
					 echo"<td style='width: 60px;'><input type='text' id='fechaFinal_".$posicionFila."' name='fechaFinal_".$posicionFila."' value='".$ordenTrabajo->fechaFinal."' readonly='readonly' style='border:none; width:60px;' /></td>";
					 
					 echo"<td style='width: 60px;'><input type='text' id='fechaEntrega_".$posicionFila."' name='fechaEntrega_".$posicionFila."' value='".$ordenTrabajo->fechaEntrega."' readonly='readonly' style='border:none; width:60px;' /></td>";
					 
					 echo"<td style='width: 60px;'><input type='text' id='fechaAcabado_".$posicionFila."' name='fechaAcabado_".$posicionFila."' value='".$ordenTrabajo->fechaAcabado."' readonly='readonly' style='border:none; width:60px;' /></td>";
					 
					 echo"<td style='width: 40px;'><input type='text' id='estadoItem_".$posicionFila."' name='estadoItem_".$posicionFila."' value='".$ordenTrabajo->estadoItem."' readonly='readonly' style='border:none; width:40px;text-align:center;' /></td>";
					
					 if($ordenTrabajo->estadoItem=='T'){		//... solo ordenes ya signadas ...		 
					 	echo"<td style='width:50px;background-color:#b9e9ec;' align='left'><a href='#' onClick='reportePdf($numeOrdenTrabajo);'><span class='glyphicon glyphicon-print'></span> PDF</a></td>";
					 }
					 
					 if($ordenTrabajo->estadoItem=='P'){		//... solo ordenes ya signadas ...		 
					 	echo"<td style='width:50px;background-color:#b9e9ec;' align='left'><a href='#' onClick='reportePdf($numeOrdenTrabajo);'><span class='glyphicon glyphicon-print'></span> PDF</a></td>";
					 
					 	echo"<td style='width:75px;background-color:#a5d4da;align=left;'><a href='#' data-title='Terminar orden de trabajo' data-item-id='".$ordenTrabajo->numeroPedido."-".$ordenTrabajo->secuencia."' data-producto='".$ordenTrabajo->descripcion."'
					    data-numeropedido='".$ordenTrabajo->numeroPedido."' data-secuencia='".$ordenTrabajo->secuencia."' data-color='".$ordenTrabajo->color."' data-estado='".$ordenTrabajo->estadoItem."' data-toggle='modal' data-target='#editarModal'><span class='glyphicon glyphicon-ok'></span> Terminar</a></td>";
					 }
