...
<style type="text/css" >
	...
	#cuerpoCabecera{margin:0 auto; padding:0; width:820px; height:105px;}
...
<div class="jumbotron" id="cuerpoCabecera" >	<!--cuerpoCrudMaterial-->
	    ...
	    <form class="form-horizontal" method="post" action="<?=base_url()?>produccion/buscarPedidoCrud" id="formBuscarRegistro_" name="formBuscarRegistro_" >
	    	<div style="height:2px;"></div>
			<p align="center" class="tituloReporte" ><span class="label label-default"> CRUD pedidos </span></p>
