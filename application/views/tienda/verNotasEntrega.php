				...
				<tr class='letraDetalle'>
					...
					if(strlen($numeroEntrega)==6){						//...si es nota de entrega de Fabrica ... 
					 ...
					 if($permisoUserName=='superuser'){
					 	echo"<td style='width:65px;background-color:#a5d4da;align=left;'><a href='#' data-title='Eliminar proforma' data-item-id='".$entrega->entrega."' data-cli='".$entrega->cliente."' data-toggle='modal' data-target='#borrarModal'><span class='glyphicon glyphicon-trash'></span> Eliminar</a></td>"; 
					 }else{
