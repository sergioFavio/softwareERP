...
function pedidoPdf(nPedido){
	...
	$.ajax({
      url: "<?=base_url()?>produccion/pedidoZPdfCrud",
...
<div class="jumbotron" id="cuerpoCabecera" >	<!--cuerpoCrudMaterial-->
	    ...
	    <form class="form-horizontal" method="post" action="<?=base_url()?>tienda/buscarPedidoZ" id="formBuscarRegistro_" name="formBuscarRegistro_" >
			...
			<div class="row">
			    ...
			    <div class="col-xs-1"> 
			   	...
			   	<div class="col-xs-3"> 
					<span  id="titulo" class="label label-success"> V e r  &nbsp;&nbsp;&nbsp;&nbsp; P e d i d o s &nbsp;&nbsp;&nbsp;&nbsp;Z &uacute; ñ i g a </span>
			   	</div>
...
<div class="modal fade" id="borrarModal" tabindex="-1" role="dialog" aria-labelledby="borrarModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form class="form-horizontal" data-async data-target="#rating-modal" action="<?=base_url()?>tienda/eliminarPedidoZ" method="POST">
