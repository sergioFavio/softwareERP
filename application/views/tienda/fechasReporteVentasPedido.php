...
<div class="jumbotron" id="cuerpo" >
	<?php 
		if($atributo=='P'){
			//... reporte 30 productos mas vendidos ...
			$reporte='generarReporteMasVendidos';
		}else{
	...
	<div class="cuerpoCabeceraReporteSalida">
	    <form class='form-horizontal' method='post' action='<?=base_url()?>tienda/<?=$reporte?>' id='form_' name='form_' >
			...
			<p align="center" class="tituloReporte" ><span class="label label-default"> Fechas reporte ventas </span></p>
