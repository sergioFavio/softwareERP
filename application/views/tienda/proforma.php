        ...
        //if ciclo de impresion de filas 
       		for($x=0; $x<25; $x++){
            	echo "<tr class='detalleMaterial' >";
                    ...
                    echo "<td class='letraDetalle'  style='width: 420px; background-color: #f9f9ec;' ><textarea rows='5' class='letraCentreada' id='mat_".$x."' name='mat_".$x."'  style='width:400px;border:none;' /></textarea></td>";
