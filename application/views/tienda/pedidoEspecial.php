   ...
   <form class="form-horizontal" method="post" action="<?=base_url()?>tienda/grabarPedido" id="form_" name="form_" >
	...
	<div class="cabeceraIngreso">
		<div class="row-fluid">
	    	...
	    	<div class="col-xs-2">
	    	 	<span id="titulo" class="label label-success">Pedido:<?= $pedido ?> </span>
	    	</div> 
        ...
        //if ciclo de impresion de filas 
       		for($x=0; $x<15; $x++){
            	echo "<tr class='detalleMaterial' >";
					...
					echo"<td  style='width: 80px; background-color: #d9f9ec;' fila=$x ><input type='text' class='letraDetalle' name='idMat_'.$x id='idMat_'.$x   style='width: 60px; border:none; background-color: #d9f9ec;' /></td>";
					
                    echo"<td  style='width: 320px; background-color: #f9f9ec;' ><textarea rows='5'  class='letraDetalle' id='mat_'.$x. name='mat_'.$x  style='width:300px;border:none;' /></textarea></td>";
