<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    class ListadoExistenciasGrupoPdf extends FPDF {
        ...
        public function Header(){
			...
			$this->Cell(120,10,utf8_decode('Listado Existencias: '.$this->nombreGrupo),0,0,'C');	
	        ...
	        */	 
			...
			$this->Cell(35,7,'','TB',0,'C','0');
			$this->Cell(10,7,'unidad','TB',0,'C','0');
			$this->Cell(15,7,'','TB',0,'C','0');
			$this->Cell(12,7,'exist.','TB',0,'C','0');
			$this->Cell(10,7,'','TB',0,'C','0');
			$this->Cell(15,7,'invent.','TB',0,'R','0');
